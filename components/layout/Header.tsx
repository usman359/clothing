...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-pink-200/50 bg-white/95 backdrop-blur-lg supports-backdrop-filter:bg-white/90 shadow-md">
      <div className="container mx-auto flex h-20 items-center justify-between px-4 sm:px-6 lg:px-8">
        {/* Logo */}
        <Link href="/" className="flex items-center space-x-2 group">
          <div className="relative">
            <span className="text-3xl font-black bg-linear-to-r from-pink-500 via-purple-500 to-blue-500 bg-clip-text text-transparent group-hover:scale-105 transition-transform duration-300">
              ⭐ Little Stars
            </span>
        ...
        <nav className="hidden lg:flex items-center space-x-1">
          <Link
            href="/"
            className="px-4 py-2 text-sm font-semibold text-gray-700 hover:text-pink-600 rounded-lg hover:bg-pink-50 transition-all duration-200 relative group"
          >
            Home
        ...
        <div className="flex items-center space-x-3">
          ...
          >
            <ShoppingCart className="h-5 w-5 text-gray-700 group-hover:text-pink-600" />
            {itemCount > 0 && (
              <Badge
                variant="destructive"
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden border-t border-pink-200/50 bg-white shadow-lg">
          <nav className="container mx-auto flex flex-col px-4 py-4 space-y-1">
            <Link
              href="/"
              className="px-4 py-3 text-base font-semibold text-gray-700 hover:text-pink-600 rounded-lg hover:bg-pink-50 transition-all duration-200"
